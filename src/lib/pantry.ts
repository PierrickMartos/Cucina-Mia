...
export const PANTRY_ITEMS: PantryItem[] = [
  ...
  item("squash", "produce", "Courge butternut", "Butternut squash", "Zucca", ["butternut squash", "squash"]),
  ...
  // Dairy and eggs
  item("eggs", "dairy", "Œufs", "Eggs", "Uova", ["egg", "egg yolk", "egg white"]),
  item("butter", "dairy", "Beurre", "Butter", "Burro", ["butter"]),
  item("ghee", "dairy", "Ghee", "Ghee", "Ghee", ["ghee"]),
  item("milk", "dairy", "Lait", "Milk", "Latte", ["milk"]),
  ...
  item("cornstarch", "pantry", "Maïzena", "Cornstarch", "Amido di mais", ["cornstarch"]),
